    ...
    <section className=" body-font overflow-hidden">
      <div className="container px-5 pt-[4rem] mx-auto">
        <div className="flex flex-col w-full mb-8">
          <h1 className="sm:text-4xl text-[2.5rem]  font-bold title-font mb-2 text-[#544214]">
            Plan and pricing
          </h1>
          ...
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full  rounded-[1rem] border-2 bg-[#FFE5A2]  flex flex-col relative overflow-hidden">
              <div className="bg-[#544214] text-center rounded-[1rem]">
                <h1 className="text-5xl text-[#FFE5A2] text-[2rem]  font-bold p-4 mb-4 leading-none">
                  Plan A
                </h1>
              </div>
              ...
              <div className="text-center my-10">
                <button className=" items-center  text-[#FFE5A2] bg-[#544214] border-0 py-2 px-4  focus:outline-none hover:bg-[#FFFBF2] hover:text-[#544214] rounded-full">
                  Order Now
                </button>
              </div>
            </div>
      ...
      <div className="container px-5 py-[4rem] mx-auto">
        ...
        <div className="  rounded-[1rem] bg-[#FFE5A2] p-[2rem] md:p-[6rem] my-[2rem]">
          <p className="text-[#000000] font-bold pb-7">
          ...
          <div className="flex flex-wrap gap-[2rem] justify-center ">
            <div className="bg-[#544214] rounded-[2rem] p-[1rem] md:p-[3rem]">
              <p className="text-[#FFE5A2]">
                On one student referral you get a 15% discount.
              </p>
            </div>
            <div className="bg-[#544214] rounded-[2rem] p-[1rem] md:p-[3rem]">
              <p className="text-[#FFE5A2]">
                On two student referral you get a 25% discount.
              </p>
            </div>
          </div>
        </div>
